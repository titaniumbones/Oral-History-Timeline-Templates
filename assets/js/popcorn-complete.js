...
(function ( Popcorn ) {
   ...
   *                          Stamen custom map types (http://maps.stamen.com): STAMEN-TONER,
  ...
  Popcorn.plugin( "googlemap", function ( options ) {
    ...
    newdiv.className += "googlemap-container";
    ...
    if ( options.height ) {
      newdiv.style.height = options.height;
        ...
        // console.log("this is target clientheight" + target.clientHeight);
      newdiv.style.height = target.clientHeight + "px";
    } else {
      newdiv.style.height = "100%";
        console.log("this is target clientheight");
    }
  ...
  Popcorn.player( "youtube", {
    ...
    _setup: function( options ) {
      if ( !window.YT && !_loading ) {
        _loading = true;
        Popcorn.getScript( "http://youtube.com/player_api" );
      }
